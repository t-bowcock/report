...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{overlay}
...
Now the format of the search and the data it returns the front end could be implemented to generate those searchs and display the data.
