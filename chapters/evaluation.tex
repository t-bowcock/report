...
This section will compare the finised project to the project aims set out in the introduction.
\begin{description}
...
\end{description}
To acheive this aim an Angular and Django based web application was developed that contains a graph showing the interactions between items in the game. 
The user can get detailed information on the item or interation by clicking on the corresponding area of the graph, and the data the graph represents can be 
...
Over the course of this project I have had to oppotunity to pick up and develop many new skills, this section will cover 
...
an opportunity to try something new and find that this style of databse isn't that intimidating. Looking back at work completed 
...
I chose this combination because of using it on my placement. However, I know realise there were some aspects of that implementation that were 
...
Using cytoscape made displaying the graph for this project, which contains a lot more data, much easier and it is definitly a tool I would 
